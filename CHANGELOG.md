...
## [v2.1.1](https://github.com/jaakkos/winston-logstash/compare/v2.1.0...v2.1.1)

### Merged

- deps(test): bump brace-expansion from 1.1.14 to 1.1.18 in /test-bench/winston-2x in the npm_and_yarn group across 1 directory [`#162`](https://github.com/jaakkos/winston-logstash/pull/162)
- deps: bump the dev-dependencies group across 1 directory with 4 updates [`#160`](https://github.com/jaakkos/winston-logstash/pull/160)
- deps: bump brace-expansion from 1.1.12 to 1.1.18 [`#164`](https://github.com/jaakkos/winston-logstash/pull/164)
- deps(test): bump brace-expansion [`#163`](https://github.com/jaakkos/winston-logstash/pull/163)
- deps: bump fast-uri from 3.1.4 to 3.1.5 [`#161`](https://github.com/jaakkos/winston-logstash/pull/161)

## [v2.1.0](https://github.com/jaakkos/winston-logstash/compare/v2.0.5...v2.1.0) - 2026-07-23

### Merged

- deps: bump typescript from 5.9.3 to 6.0.3 [`#159`](https://github.com/jaakkos/winston-logstash/pull/159)
- ci: bump actions/setup-node from 6 to 7 [`#158`](https://github.com/jaakkos/winston-logstash/pull/158)
- deps: bump the dev-dependencies group with 3 updates [`#154`](https://github.com/jaakkos/winston-logstash/pull/154)
- ci: bump actions/checkout from 6 to 7 [`#151`](https://github.com/jaakkos/winston-logstash/pull/151)
- deps: bump fast-uri from 3.1.2 to 3.1.4 [`#157`](https://github.com/jaakkos/winston-logstash/pull/157)
- deps(test): bump body-parser [`#156`](https://github.com/jaakkos/winston-logstash/pull/156)
- deps: bump typescript-eslint in the dev-dependencies group [`#153`](https://github.com/jaakkos/winston-logstash/pull/153)
- deps: bump the dev-dependencies group with 3 updates [`#152`](https://github.com/jaakkos/winston-logstash/pull/152)
- deps: bump the dev-dependencies group with 2 updates [`#149`](https://github.com/jaakkos/winston-logstash/pull/149)
- deps: bump the dev-dependencies group with 2 updates [`#148`](https://github.com/jaakkos/winston-logstash/pull/148)
- deps: bump the dev-dependencies group across 1 directory with 10 updates [`#147`](https://github.com/jaakkos/winston-logstash/pull/147)
- deps(test): bump qs [`#145`](https://github.com/jaakkos/winston-logstash/pull/145)
- deps: bump the dev-dependencies group with 2 updates [`#144`](https://github.com/jaakkos/winston-logstash/pull/144)

### Commits

- feat: add opt-in retry_transient_errors_only for fail-fast TLS errors [`80d8046`](https://github.com/jaakkos/winston-logstash/commit/80d80469dab292f9faf8606321c012b5a7907dbb)
- test: add audit characterization tests and findings for known bugs [`bbe5067`](https://github.com/jaakkos/winston-logstash/commit/bbe5067b1b0435d0e1a2768a2ddd8b5073aa513c)
- test: expand test-bench coverage for silent, TLS retry, and close [`6ed7c10`](https://github.com/jaakkos/winston-logstash/commit/6ed7c1044d3e784c3e8becc5224d1cfbed60d498)
- fix: add opt-in socket timeout and serialize log flush [`dcbd7b3`](https://github.com/jaakkos/winston-logstash/commit/dcbd7b36c07cef581d1a4ca8eeb8255732d35504)
- docs: remove resolved bug audit findings [`f4b06bd`](https://github.com/jaakkos/winston-logstash/commit/f4b06bd1a5cb91e41c6830f731e166f278b922cc)
- fix: honor Winston 3 silent mode and clear retry timer on close [`c8e0078`](https://github.com/jaakkos/winston-logstash/commit/c8e00784e42e946a94fab8ae253a304314fa09dc)
- Release v2.1.0 [`76c0f11`](https://github.com/jaakkos/winston-logstash/commit/76c0f119a2ff22a6eacd98868304a621e020ff4f)
- ci: add Node.js 26.x to the test matrix [`73e7ae8`](https://github.com/jaakkos/winston-logstash/commit/73e7ae812612e5276bef1ae9f7a59171d8254f24)

## [v2.0.5](https://github.com/jaakkos/winston-logstash/compare/v2.0.4...v2.0.5) - 2026-05-12

### Merged

- deps: bump the dev-dependencies group across 1 directory with 7 updates [`#142`](https://github.com/jaakkos/winston-logstash/pull/142)
- deps: bump @babel/plugin-transform-modules-systemjs [`#143`](https://github.com/jaakkos/winston-logstash/pull/143)
- deps(test): bump the npm_and_yarn group across 1 directory with 2 updates [`#141`](https://github.com/jaakkos/winston-logstash/pull/141)
- deps(test): bump the npm_and_yarn group across 1 directory with 2 updates [`#140`](https://github.com/jaakkos/winston-logstash/pull/140)
- deps: bump fast-uri from 3.1.0 to 3.1.2 [`#139`](https://github.com/jaakkos/winston-logstash/pull/139)
- deps: bump the dev-dependencies group with 2 updates [`#135`](https://github.com/jaakkos/winston-logstash/pull/135)
- deps: bump lodash from 4.17.23 to 4.18.1 [`#130`](https://github.com/jaakkos/winston-logstash/pull/130)
- deps: bump the dev-dependencies group with 2 updates [`#131`](https://github.com/jaakkos/winston-logstash/pull/131)
- ci: bump dependabot/fetch-metadata from 2 to 3 [`#134`](https://github.com/jaakkos/winston-logstash/pull/134)
- ci: bump softprops/action-gh-release from 2 to 3 [`#133`](https://github.com/jaakkos/winston-logstash/pull/133)
- deps: bump the dev-dependencies group with 4 updates [`#129`](https://github.com/jaakkos/winston-logstash/pull/129)
- deps(test): bump path-to-regexp [`#128`](https://github.com/jaakkos/winston-logstash/pull/128)
- deps: bump handlebars from 4.7.8 to 4.7.9 [`#127`](https://github.com/jaakkos/winston-logstash/pull/127)

### Commits

- Release v2.0.5 [`00c3100`](https://github.com/jaakkos/winston-logstash/commit/00c3100756591616b9cb3616fa2afb4a8aa6bfdd)

## [v2.0.4](https://github.com/jaakkos/winston-logstash/compare/v2.0.3...v2.0.4) - 2026-03-26

### Merged

- deps: bump @eslint/js from 9.39.2 to 10.0.1 [`#115`](https://github.com/jaakkos/winston-logstash/pull/115)
- deps: bump eslint from 9.39.2 to 10.0.0 [`#114`](https://github.com/jaakkos/winston-logstash/pull/114)
- deps: bump flatted from 3.3.3 to 3.4.2 [`#121`](https://github.com/jaakkos/winston-logstash/pull/121)
- deps: bump the dev-dependencies group across 1 directory with 6 updates [`#122`](https://github.com/jaakkos/winston-logstash/pull/122)
- deps(test): bump picomatch [`#126`](https://github.com/jaakkos/winston-logstash/pull/126)
- deps: bump picomatch from 2.3.1 to 2.3.2 [`#125`](https://github.com/jaakkos/winston-logstash/pull/125)
- deps(test): bump picomatch [`#124`](https://github.com/jaakkos/winston-logstash/pull/124)
- deps: bump minimatch from 3.1.2 to 3.1.5 [`#118`](https://github.com/jaakkos/winston-logstash/pull/118)
- deps(test): bump qs [`#116`](https://github.com/jaakkos/winston-logstash/pull/116)
- deps: bump the dev-dependencies group with 4 updates [`#113`](https://github.com/jaakkos/winston-logstash/pull/113)
- deps(test): bump the npm_and_yarn group across 1 directory with 2 updates [`#111`](https://github.com/jaakkos/winston-logstash/pull/111)
- deps(test): bump @babel/traverse [`#110`](https://github.com/jaakkos/winston-logstash/pull/110)

### Commits

- Release v2.0.4 [`3106a75`](https://github.com/jaakkos/winston-logstash/commit/3106a75c441464d0ed4da618d4775eb2664be24b)
- Pump Logstash version [`1c8eca0`](https://github.com/jaakkos/winston-logstash/commit/1c8eca040bf5df4687cc74a9fec874f9546051a9)

## [v2.0.3](https://github.com/jaakkos/winston-logstash/compare/v2.0.2...v2.0.3) - 2026-01-24

### Merged

- Potential fix for code scanning alert no. 1: Workflow does not contain permissions [`#109`](https://github.com/jaakkos/winston-logstash/pull/109)
- Potential fix for code scanning alert no. 2: Workflow does not contain permissions [`#108`](https://github.com/jaakkos/winston-logstash/pull/108)
- Upgrade ESLint to v9 and apply formatting fixes [`#107`](https://github.com/jaakkos/winston-logstash/pull/107)
- deps: bump @jest/globals from 29.7.0 to 30.2.0 [`#104`](https://github.com/jaakkos/winston-logstash/pull/104)
- deps: bump winston from 2.4.6 to 3.19.0 [`#105`](https://github.com/jaakkos/winston-logstash/pull/105)
- deps: bump mocha from 10.8.2 to 11.7.5 [`#103`](https://github.com/jaakkos/winston-logstash/pull/103)
- deps: bump jest and @types/jest [`#102`](https://github.com/jaakkos/winston-logstash/pull/102)
- deps: bump chai from 4.5.0 to 6.2.2 [`#101`](https://github.com/jaakkos/winston-logstash/pull/101)
- ci: bump actions/checkout from 4 to 6 [`#99`](https://github.com/jaakkos/winston-logstash/pull/99)
- ci: bump actions/setup-node from 4 to 6 [`#98`](https://github.com/jaakkos/winston-logstash/pull/98)
- deps(test): bump express from 4.22.1 to 5.2.1 in /test-bench/sandbox [`#100`](https://github.com/jaakkos/winston-logstash/pull/100)

### Commits

- Add Dependabot configuration for automated dependency updates [`7f37620`](https://github.com/jaakkos/winston-logstash/commit/7f376200bb6fcb9049871dfcb30b0ff16c18b2c4)
- Add auto-merge workflow for Dependabot PRs [`bff7dc3`](https://github.com/jaakkos/winston-logstash/commit/bff7dc3cf0e7bd6e58f7658e62bc757055f4447f)
- Release v2.0.3 [`194a2c0`](https://github.com/jaakkos/winston-logstash/commit/194a2c03f1b7f66f89b41faa3fcab2ac8754aa20)
- Auto-merge GitHub Actions patch updates [`3ef2507`](https://github.com/jaakkos/winston-logstash/commit/3ef25079639ac4a548725bd3fa6f365e84a46cab)
- Fix auto-merge logic to require manual review for GitHub Actions minor updates [`621b4c5`](https://github.com/jaakkos/winston-logstash/commit/621b4c536c4e348393ebe34af3980fa908f77e0a)

## [v2.0.2](https://github.com/jaakkos/winston-logstash/compare/v2.0.1...v2.0.2) - 2026-01-24

### Commits

- Add manual release workflow with GitHub UI trigger [`ff7e75b`](https://github.com/jaakkos/winston-logstash/commit/ff7e75b19a60f78b3b142125e917ffd9d08bc48b)
- Add GitHub Actions workflow for automated releases [`876fefa`](https://github.com/jaakkos/winston-logstash/commit/876fefab8dd2b33b8f06baf87e85f09df2878fbe)
- Improve release workflow with changelog generation [`f834f5f`](https://github.com/jaakkos/winston-logstash/commit/f834f5f3b6fda103b5a31bc3e809a1878b3b6196)
- Update release workflow to use npm Trusted Publishing (OIDC) [`fea35c1`](https://github.com/jaakkos/winston-logstash/commit/fea35c12ba2ad14a79593ec3cd3e9472953227c6)
- Release v2.0.2 [`053a6ba`](https://github.com/jaakkos/winston-logstash/commit/053a6ba35926e18181dd938d90285fd2ff24685d)
- Add provenance attestation for npm publishing [`1fa9795`](https://github.com/jaakkos/winston-logstash/commit/1fa9795536a42c8f8efb9bdb35b403ef8a89c740)
- Add npm-publish environment for secure releases [`c08f273`](https://github.com/jaakkos/winston-logstash/commit/c08f27331cf82f4ec59b07d9401d2621e106d489)

## [v2.0.1](https://github.com/jaakkos/winston-logstash/compare/v2.0.0...v2.0.1) - 2026-01-24
...
- Release v2.0.1 [`4c75219`](https://github.com/jaakkos/winston-logstash/commit/4c752193fa2da6b1fc0c4f44ff51d87994d56b28)
